...
router.post("/", ProprietarioController.createProprietario);//1.endpoint: criação de um proprietário
...
router.put("/", ProprietarioController.updateProprietario);//2.endpoint: atualização de um proprietário
